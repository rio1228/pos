			...
			<DIV id="pie-contents">
				<DIV id="analysis">
					<DIV id="analisis_nav">
						...
						<DIV id="temp_pie" title="気温別分析"><a href="http://localhost:8080/PosSystem/retails/marketing_analysis_temp.jsp"><IMG ALT="気温別分析へ移動します" SRC="../img/temp.png" ></a><span></span></DIV>
					...
					<DIV id="analysis-chart">
						...
						<script type="text/javascript" src="http://localhost:8080/PosSystem/js/analysis/pie_temp.js" charset="utf-8"></script>
