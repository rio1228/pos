			...
			<DIV id="pie-contents">
				<DIV id="analysis">
					<DIV id="analisis_nav">
						...
						<DIV id="weather_pie" title="天候別分析"><a href="http://localhost:8080/PosSystem/retails/marketing_analysis_weather.jsp"><IMG ALT="天候別分析へ移動します" SRC="../img/sun.png" ></a><span></span></DIV>
					...
					<DIV id="analysis-chart">
						...
						<script type="text/javascript" src="http://localhost:8080/PosSystem/js/analysis/pie_weather.js" charset="utf-8"></script>
