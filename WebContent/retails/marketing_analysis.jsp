	...
	<DIV id="main"><!-- 中身。動的に変わる -->
		<DIV id="contents">
			<DIV id="pie-contents">
				<DIV id="analysis">
					<DIV id="analisis_nav">
						<DIV id="home_pie" title="総合分析"><a href="http://localhost:8080/PosSystem/retails/marketing_analysis.jsp"><IMG ALT="総合別分析へ移動します" SRC="../img/home.png"></a><span></span></DIV>
						<DIV id="sex_pie" title="性別分析へ移動します"><a href="http://localhost:8080/PosSystem/retails/marketing_analysis_sex.jsp"><IMG ALT="性別分析" SRC="../img/sex.png"></a></DIV>
					...
					<DIV id="analysis-chart">
						...
						<script type="text/javascript" src="http://localhost:8080/PosSystem/js/vendor/jquery.adaptive-backgrounds.js" charset="utf-8"></script>
						...
						<script type="text/javascript" src="http://localhost:8080/PosSystem/js/analysis/pie.js" charset="utf-8"></script>
