			...
			<DIV id="pie-contents">
				<DIV id="analysis">
					<DIV id="analisis_nav">
						...
						<DIV id="human_pie" title="年代別分析"><a href="http://localhost:8080/PosSystem/retails/marketing_analysis_human.jsp"><IMG ALT="年代別分析へ移動します" SRC="../img/human.png" ></a><span></span></DIV>
					</DIV>
					<DIV id="analysis-chart">
						...
						<script type="text/javascript" src="http://localhost:8080/PosSystem/js/analysis/pie_human.js" charset="utf-8"></script>
