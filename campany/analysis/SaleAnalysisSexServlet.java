...
/**
 * Servlet implementation class SaleAnalysisSexServlet
 */
@WebServlet("/SaleAnalysisSexServlet")
public class SaleAnalysisSexServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public SaleAnalysisSexServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		saleCate = wc.saleCateOnlySex(saleTbl);
