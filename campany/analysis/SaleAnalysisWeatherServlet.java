...
/**
 * Servlet implementation class SaleAnalysisWeatherServlet
 */
@WebServlet("/SaleAnalysisWeatherServlet")
public class SaleAnalysisWeatherServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public SaleAnalysisWeatherServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		saleCate = wc.saleCateOnlyWeather(saleTbl);
