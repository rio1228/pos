...
/**
 * Servlet implementation class SaleAnalysisHumanServlet
 */
@WebServlet("/SaleAnalysisHumanServlet")
public class SaleAnalysisHumanServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public SaleAnalysisHumanServlet() {
        super();
